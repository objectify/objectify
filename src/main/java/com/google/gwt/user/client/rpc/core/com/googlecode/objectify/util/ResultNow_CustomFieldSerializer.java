...
public class ResultNow_CustomFieldSerializer extends CustomFieldSerializer<ResultNow> {
  ...
  public static void deserialize(SerializationStreamReader streamReader, ResultNow instance) throws SerializationException {
    instance = new ResultNow(streamReader.readObject());
  }
  ...
  public static void serialize(SerializationStreamWriter streamWriter, ResultNow instance) throws SerializationException {
    streamWriter.writeObject(instance.now());
  }
