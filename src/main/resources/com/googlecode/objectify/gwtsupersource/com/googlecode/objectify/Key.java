...
//    /**
//     * Reconstitute a Key from a web safe string. This can be generated with
//     * getString() or KeyFactory.strongToKey().
//     */
...
//    }
    ...
    /**
     * @return the parent key, or null if there is no parent. Note that the
     *         parent could potentially have any type.
     */
    ...
    /**
     * Gets the root of a parent graph of keys. If a Key has no parent, it is
     * the root.
     * 
...
//    /**
//     * Call KeyFactory.keyToString() on the underlying Key. You can reconstitute
//     * a Key<?> using the constructor that takes a websafe string.
//     */
...
//    /**
//     * <p>
//     * Determines the kind for a Class, as understood by the datastore. The
//     * first class in a hierarchy that has @Entity defines the kind (either
//     * explicitly or as that class' simplename).
//     * </p>
//     * 
...
//    /**
//     * Get the kind from the class if the class has an @Entity annotation,
