...
public class BasicTests extends TestBase
{
	...
	public void testGenerateId() throws Exception
	{
		...
		OKey<Trivial> created = ObjectifyFactory.createKey(Trivial.class, k.getId());
	...
	public void testNames() throws Exception
	{
		...
		OKey<NamedTrivial> createdKey = ObjectifyFactory.createKey(NamedTrivial.class, "first");
	...
	public void testManyToOne() throws Exception
	{
		...
		OKey<Employee> fredKey = ObjectifyFactory.createKey(fred);
