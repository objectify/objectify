...
public class Child
{
	...
	@Parent
	OKey<Trivial> parent;
	public OKey<Trivial> getParent() { return this.parent; }
	public void setParent(OKey<Trivial> value) { this.parent = value; }
	...
	public Child(OKey<Trivial> parent, String childString)
	{
		this.parent = parent;
